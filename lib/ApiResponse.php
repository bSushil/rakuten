    ...
    ArrayAccess
{
     ...
     */
    public function __construct($operation, \Rakuten\HttpResponse $response)
    {
    ...
    {
        throw new \Rakuten\Exception("Cannot set data");
    }

    public function offsetUnset($offset)
    {
        throw new \Rakuten\Exception("Cannot unset data");
    }
}
